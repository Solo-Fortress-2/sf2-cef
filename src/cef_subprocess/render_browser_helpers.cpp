 ...
 * render_browser_helpers.cpp, Helpers to handle V8 (JS engine) contexts and JS objects.
 *
...
{
	CefRefPtr<CefV8Value> ret = nullptr;
	...
	case VTYPE_DICTIONARY:
	{
		...
		CefRefPtr<CefV8Value> v = CefV8Value::CreateObject(nullptr, nullptr);
		if (v)
		{
