...
class CCefOSRRenderer : public CefRenderHandler
{
public:
	CCefOSRRenderer(CCefBrowser* pBrowser, bool transparent);
	virtual ~CCefOSRRenderer();
...
private:
	...
	IMPLEMENT_REFCOUNTING(CCefOSRRenderer);
};

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
inline vgui::CursorCode CCefOSRRenderer::GetCursor()
{
	return m_Cursor;
}
